...
void main() {
  ...
  group('Update Vector Integers', () {
    ...
    test('other elements unchanged', () {
      ...
      try {
        db.createElement('Configuration', {'label': 'Test Config'});
        db.createElement('Collection', {'label': 'Item 1', 'value_int': [1, 2, 3]});
        db.createElement('Collection', {'label': 'Item 2', 'value_int': [10, 20]});
  ...
  group('Update Vector Doubles', () {
    test('replace existing vector', () {
      ...
      try {
        db.createElement('Configuration', {'label': 'Test Config'});
        db.createElement('Collection', {'label': 'Item 1', 'value_float': [1.5, 2.5, 3.5]});
    ...
    test('precision test', () {
      ...
      try {
        db.createElement('Configuration', {'label': 'Test Config'});
        db.createElement('Collection', {'label': 'Item 1', 'value_float': [1.0]});
  ...
  group('Update Set Strings', () {
    test('replace existing set', () {
      ...
      try {
        db.createElement('Configuration', {'label': 'Test Config'});
        db.createElement('Collection', {'label': 'Item 1', 'tag': ['important', 'urgent']});
    ...
    test('other elements unchanged', () {
      ...
      try {
        db.createElement('Configuration', {'label': 'Test Config'});
        db.createElement('Collection', {'label': 'Item 1', 'tag': ['important']});
        db.createElement('Collection', {'label': 'Item 2', 'tag': ['urgent', 'review']});
    ...
    test('unicode support', () {
      ...
      try {
        db.createElement('Configuration', {'label': 'Test Config'});
        db.createElement('Collection', {'label': 'Item 1', 'tag': ['tag1']});
