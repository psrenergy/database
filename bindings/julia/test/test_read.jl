...
@testset "Read" begin
    ...
    @testset "Get Attribute Type - Scalar Integer" begin
        ...
        result = Quiver.get_attribute_type(db, "Configuration", "integer_attribute")
        @test result.data_structure == Quiver.QUIVER_DATA_STRUCTURE_SCALAR
        @test result.data_type == Quiver.QUIVER_DATA_TYPE_INTEGER
    ...
    @testset "Get Attribute Type - Scalar Real" begin
        ...
        result = Quiver.get_attribute_type(db, "Configuration", "float_attribute")
        @test result.data_structure == Quiver.QUIVER_DATA_STRUCTURE_SCALAR
        @test result.data_type == Quiver.QUIVER_DATA_TYPE_FLOAT
    ...
    @testset "Get Attribute Type - Scalar Text" begin
        ...
        result = Quiver.get_attribute_type(db, "Configuration", "string_attribute")
        @test result.data_structure == Quiver.QUIVER_DATA_STRUCTURE_SCALAR
        @test result.data_type == Quiver.QUIVER_DATA_TYPE_STRING
    ...
    @testset "Get Attribute Type - Vector Integer" begin
        ...
        result = Quiver.get_attribute_type(db, "Collection", "value_int")
        @test result.data_structure == Quiver.QUIVER_DATA_STRUCTURE_VECTOR
        @test result.data_type == Quiver.QUIVER_DATA_TYPE_INTEGER
    ...
    @testset "Get Attribute Type - Vector Real" begin
        ...
        result = Quiver.get_attribute_type(db, "Collection", "value_float")
        @test result.data_structure == Quiver.QUIVER_DATA_STRUCTURE_VECTOR
        @test result.data_type == Quiver.QUIVER_DATA_TYPE_FLOAT
    ...
    @testset "Get Attribute Type - Set Text" begin
        ...
        result = Quiver.get_attribute_type(db, "Collection", "tag")
        @test result.data_structure == Quiver.QUIVER_DATA_STRUCTURE_SET
        @test result.data_type == Quiver.QUIVER_DATA_TYPE_STRING
    ...
    @testset "Get Attribute Type - Error on Nonexistent" begin
        ...
        @test_throws Quiver.DatabaseException Quiver.get_attribute_type(
            db,
            "Configuration",
            "nonexistent",
        )
    ...
    @testset "Generic Read - Scalar Integer" begin
        ...
        result = Quiver.read(db, "Configuration", "integer_attribute")
        @test result == [42, 100]
    ...
    @testset "Generic Read - Scalar Float" begin
        ...
        result = Quiver.read(db, "Configuration", "float_attribute")
    ...
    @testset "Generic Read - Scalar String" begin
        ...
        result = Quiver.read(db, "Configuration", "string_attribute")
    ...
    @testset "Generic Read - Vector Integer" begin
        ...
        result = Quiver.read(db, "Collection", "value_int")
    ...
    @testset "Generic Read - Vector Float" begin
        ...
        Quiver.create_element!(db, "Configuration"; label = "Test Config")
        Quiver.create_element!(db, "Collection"; label = "Item 1", value_float = [1.5, 2.5, 3.5])
        Quiver.create_element!(db, "Collection"; label = "Item 2", value_float = [10.5, 20.5])

        result = Quiver.read(db, "Collection", "value_float")
    ...
    @testset "Generic Read - Set String" begin
        ...
        result = Quiver.read(db, "Collection", "tag")
        @test length(result) == 2
        @test sort(result[1]) == ["important", "urgent"]
        @test result[2] == ["review"]
    ...
    @testset "Generic Read - Empty Result" begin
        ...
        result = Quiver.read(db, "Collection", "some_integer")
        @test result == Int64[]
    ...
    @testset "Generic Read - Invalid Collection" begin
        ...
        @test_throws Quiver.DatabaseException Quiver.read(db, "NonexistentCollection", "label")
    ...
    @testset "Generic Read - Invalid Attribute" begin
        ...
        @test_throws Quiver.DatabaseException Quiver.read(db, "Configuration", "nonexistent_attribute")
    ...
    @testset "Generic Read by ID - Scalar Integer" begin
        ...
        @test Quiver.read_by_id(db, "Configuration", "integer_attribute", 1) == 42
        @test Quiver.read_by_id(db, "Configuration", "integer_attribute", 2) == 100
    ...
    @testset "Generic Read by ID - Scalar Float" begin
        ...
        @test Quiver.read_by_id(db, "Configuration", "float_attribute", 1) == 3.14
        @test Quiver.read_by_id(db, "Configuration", "float_attribute", 2) == 2.71
    ...
    @testset "Generic Read by ID - Scalar String" begin
        ...
        @test Quiver.read_by_id(db, "Configuration", "string_attribute", 1) == "hello"
        @test Quiver.read_by_id(db, "Configuration", "string_attribute", 2) == "world"
    ...
    @testset "Generic Read by ID - Vector Integer" begin
        ...
        @test Quiver.read_by_id(db, "Collection", "value_int", 1) == [1, 2, 3]
        @test Quiver.read_by_id(db, "Collection", "value_int", 2) == [10, 20]
    ...
    @testset "Generic Read by ID - Vector Float" begin
        ...
        @test Quiver.read_by_id(db, "Collection", "value_float", 1) == [1.5, 2.5, 3.5]
        @test Quiver.read_by_id(db, "Collection", "value_float", 2) == [10.5, 20.5]
    ...
    @testset "Generic Read by ID - Set String" begin
        ...
        result1 = Quiver.read_by_id(db, "Collection", "tag", 1)
        @test sort(result1) == ["important", "urgent"]
        @test Quiver.read_by_id(db, "Collection", "tag", 2) == ["review"]
    ...
    @testset "Generic Read by ID - Scalar Not Found" begin
        ...
        @test Quiver.read_by_id(db, "Configuration", "integer_attribute", 999) === nothing
        @test Quiver.read_by_id(db, "Configuration", "float_attribute", 999) === nothing
        @test Quiver.read_by_id(db, "Configuration", "string_attribute", 999) === nothing
    ...
    @testset "Generic Read by ID - Vector Empty" begin
        ...
        @test Quiver.read_by_id(db, "Collection", "value_int", 1) == Int64[]
    ...
    @testset "Generic Read by ID - Invalid Collection" begin
        ...
        @test_throws Quiver.DatabaseException Quiver.read_by_id(
            db,
            "NonexistentCollection",
            "label",
            1,
